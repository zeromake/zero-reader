...
const config = {
    ...
    resolve: {
        ...
        alias: Object.assign({
            'zreact/devtools': isProd || isCordova ? resolve('./import/devtools.ts') : 'zreact/devtools',
            'router-history': isCordova ? resolve('./import/hash-history.ts') : resolve('./import/history.ts'),
