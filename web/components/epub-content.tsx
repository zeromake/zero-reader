...
export default class EpubContent extends Component<any, any> {
    ...
    public setHtmlPage() {
        if (this.props.setHtmlPage && this.props.columnCount !== 0) {
            const base = findDOMNode(this) as HTMLDivElement;
    ...
    protected bindObserver() {
        ...
        //     }
        // });
        Array.prototype.forEach.call((findDOMNode(this) as HTMLDivElement).querySelectorAll("image"), (element: SVGImageElement) => {
