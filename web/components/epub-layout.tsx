...
import { createElement as h, MouseEvent as RMouseEvent } from "react";
    ...
    protected bottomBarClick(type: number) {
        if (type === 1) {
            ...
            if (fscreen.fullscreenEnabled) {
                fscreen.requestFullscreen(findDOMNode(this) as HTMLDivElement);
            }
        }
    }

    protected clickPageUrl(event: RMouseEvent<HTMLElement, MouseEvent>) {
