import { createElement as h, Component, MouseEvent as RMouseEvent } from "react";
import { findDOMNode } from "react-dom";
import { addLinkCss, removeHead, filterPropsComponent, togglerFullScreen } from "~/utils";
...
export default abstract class AbcLayout<AbcState extends IAbcState, AbcMeta extends IAbcMeta> extends Component<IAbcProps<AbcMeta>, AbcState> {
    ...
    protected async init() {
        this.page = findDOMNode(this) as Element;
    ...
    protected clickPageUrl(event: RMouseEvent<HTMLLinkElement, MouseEvent>): void {
    ...
    private pageClick = (event: RMouseEvent<HTMLElement, MouseEvent>) => {
        if ((event.target as HTMLElement).nodeName === "A") {
            this.clickPageUrl(event as RMouseEvent<HTMLLinkElement, MouseEvent>);
            return;
        }
                ...
                {[
                    ...
                    h(filterPropsComponent, {
                        ...
                        "data-show": true,
                            ...
                            ref={((vdom: any) => this.page = findDOMNode(vdom) as Element)}
